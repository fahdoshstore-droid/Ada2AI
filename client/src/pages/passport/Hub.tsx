    ...
    <div dir={lang === 'ar' ? 'rtl' : 'ltr'} style={{ background: '#000A0F', minHeight: '100vh', color: 'white', fontFamily: "'Cairo', sans-serif" }}>
      ...
      <main style={{ maxWidth: '960px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <section style={{ textAlign: 'center', padding: '48px 0' }}>
          <a href="/passport/athlete" style={{ display: 'inline-block', background: 'linear-gradient(135deg, #007ABA, #00DCC8)', borderRadius: '12px', padding: '16px 40px', color: 'white', textDecoration: 'none', fontFamily: "'Orbitron', monospace", fontWeight: 700, fontSize: '15px', letterSpacing: '0.05em' }}>
