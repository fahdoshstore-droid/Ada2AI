...
import { mockFacility } from '@/lib/mock-data';
      ...
      <div className="sport-card p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-3 items-center">
            ...
            <Link href="/facility/checkin" className="px-4 py-2 rounded-xl bg-blue-500/20 border border-blue-500/30 text-blue-400 text-sm hover:bg-blue-500/30 transition-colors">{t('openQRScanner', lang)}</Link>
